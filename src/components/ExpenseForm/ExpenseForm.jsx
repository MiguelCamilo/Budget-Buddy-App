...
export default function ExpenseForm() {
	...
	return (
		<>
		<div delay={1} animation="fade-in" className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
			<div className="flex items-center justify-between mb-4">
				<div className="flex-shrink-1">
					<h2 delay={1.2} className="text-2xl sm:text-3xl leading-none font-black  text-gray-900">
						Expenses
					</h2>
					<h3 delay={1.4} className="text-base font-normal text-gray-500">
			...
			<section className="max-w-4xl p-6 pb mx-auto bg-white rounded-md shadow-md ">
				...
				<form onSubmit={handle_add_expense}>
					<div delay={1.6} animation="slide-in-bottom" className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-3">
						<div>
					...
					<div delay={1.8} className="flex justify-center mt-6">
						<button
							type="submit"
		...
		{/* expense chart */}
		<div delay={2.2} animation="fade-in" className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
		<div className="mb-4 flex items-center justify-between">
				<div>
					<h3 delay={2.4} className="text-xl font-bold text-gray-900 mb-2">
						Expense Chart
					</h3>
					<div delay={2.2} className="text-base font-normal text-gray-500">
