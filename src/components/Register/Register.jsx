...
export default function Register() {
	...
	return (
		<>
			{/* Global Container */}
			<div className="h-full w-full md:w-[50%] fixed z-[1] top-0 overflow-hidden pt-4 md:pt-20 bg-white">
				{/* Left Side */}
				<div className="w-full px-6 py-8 md:px-8">
					...
					<ScrollReveal.div delay={0.4} easing="anticipate">
						...
						<div className="flex items-center justify-between mt-4">
							...
							<Link to="/">
								<span className="text-[10px] text-center uppercase text-black hover:underline">
				...
				<div className="h-full w-[50%] fixed -z-[1] top-0 overflow-hidden right-0">
					<div
						className="w-full h-full gradient-bg bg-cover hidden md:flex"
						style={{
							backgroundImage:
